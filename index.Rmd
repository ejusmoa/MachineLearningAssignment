...
variables, where the most frequent quality classificaiton is A. Moreover, there 
...
the function will return the number of Principal Components needed to capture the
...
procedure using the K-fold technique with number of folds equal to five (k=5), as
...
boosting predictor (all of them using the testing data set). Therefore, I will choose 
